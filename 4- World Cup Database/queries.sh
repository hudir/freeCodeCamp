...
echo "$($PSQL "SELECT name FROM games LEFT JOIN teams ON games.winner_id=teams.team_id OR  games.opponent_id=team_id WHERE year=2014 AND round='Eighth-Final' ORDER BY name")"
